<template>
  ...
  <div class="md:flex md:items-center mb-6">
    ...
    <div class="md:w-2/4 pr-4">
      <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" type="text" :value="url">
    </div>
  ...
  <div v-if="created">
    <div class="bg-blue-100 border-t border-b border-blue-500 text-blue-700 px-4 py-3 pb-2" role="alert">
...
export default {
  ...
  methods: {
    ...
    async addFeed () {
      ...
      this.title = o.title
      await this.addFeedAsync({ name: o.title, url: this.url })
      this.created = true
    }
  }
}
